...
import { LayoutGrid, Settings, ClipboardList, Wallet, Flame, Sparkles, ArrowRight } from "lucide-react";
      ...
      <div className="max-w-6xl mx-auto space-y-6">
        ...
        {nothingEnabled && (
          <div className="bg-[#0d0d1a] border border-white/[0.08] rounded-3xl p-12 text-center flex flex-col items-center justify-center gap-3">
            <LayoutGrid className="w-12 h-12 text-slate-600 opacity-40 mb-1" />
            ...
            <button
              ...
              className="mt-2 px-6 py-2.5 bg-emerald-500 hover:bg-emerald-600 text-white text-xs font-black uppercase tracking-wider rounded-xl transition-all cursor-pointer shadow-[0_0_16px_rgba(16,185,129,0.3)] flex items-center justify-center gap-1.5"
            >
              ...
              {hasToday && (
                <div className="bg-[#0d0d1a] border border-white/[0.08] rounded-3xl p-6 shadow-[0_8px_32px_rgba(0,0,0,0.4)]">
                  ...
                  <div className="space-y-2 mb-4 max-h-64 overflow-y-auto pr-1">
                    {todayTodos.length === 0 ? (
                      <div className="py-8 text-center opacity-40 flex flex-col items-center justify-center">
                        <ClipboardList className="w-8 h-8 text-slate-500 mb-1" />
                  ...
                  <button
                    ...
                    className="w-full py-3 bg-violet-600 hover:bg-violet-500 text-white text-xs font-black uppercase tracking-widest rounded-xl transition-all cursor-pointer shadow-[0_0_16px_rgba(139,92,246,0.3)] flex items-center justify-center gap-1.5"
                  >
                    Open Today Workspace <ArrowRight className="w-3.5 h-3.5" />
                  </button>
                </div>
              )}
                ...
                <div className="bg-[#0d0d1a] border border-white/[0.08] rounded-3xl p-6 shadow-[0_8px_32px_rgba(0,0,0,0.4)]">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <button
                      ...
                      className="text-[10px] font-black text-emerald-400 hover:text-emerald-300 px-3 py-1 rounded-xl bg-emerald-500/10 cursor-pointer uppercase tracking-wider flex items-center gap-1"
                    >
            ...
            <div className="space-y-6">
              ...
              {hasToday && (
                <div className="bg-[#0d0d1a] border border-white/[0.08] rounded-3xl p-6 shadow-[0_8px_32px_rgba(0,0,0,0.4)] relative overflow-hidden">
                  <Flame className="w-20 h-20 text-emerald-500/10 absolute -right-3 -top-3 pointer-events-none" />
